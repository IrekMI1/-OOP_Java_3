...
/**
 * Производный класс от Member, наследует все методы и поля, определяет дополнительный функционал
 */
public class Person extends Member {
    /**
     * Конструктор класса Person с тремя параметрами, который вызывает конструктор родительского класса Member
     *
    ...
    /**
     * Конструктор класса Person с двумя параметрами, который вызывает конструктор родительского класса
     *
     * @param fullName имя и фамилия члена семьи
    ...
    /**
     * Конструктор класса Person с одним параметром, который вызывает конструктор родительского класса
     *
     * @param fullName имя и фамилия члена семьи
     */
